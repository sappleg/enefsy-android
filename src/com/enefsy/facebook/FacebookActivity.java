...
public class FacebookActivity extends Activity {
     ...
     *
	 * In this flow, the user credentials are handled by Facebook in an embedded 
	 * WebView, not by the client application. As such, the dialog makes a network 
	 * request and renders HTML content rather than a native UI. The access token 
	 * is retrieved from a redirect to a special URL that the WebView handles.
     *
    ...
    public void dialog(Context context, String action, Bundle parameters,
        ...
        if (action.equals(LOGIN)) {
            ...
            parameters.putString("client_id", FACEBOOK_CLIENT_ID);
        } else {
            parameters.putString("app_id", FACEBOOK_CLIENT_ID);
        }
